...
def save():
    ...
    if name == '' or address == '' or contact == '' or email == '':
        ...
        try:
            ...
            insert_query = """INSERT INTO user( name, email,contactno,address) VALUES( %s, %s, %s, %s)""", (
                vals['name'], vals['email'], int(vals['contactno']), vals['address'])
...
billing = Button(text='Billing', width=19, border=0, bg='#595B67', fg='white', font=(
...
# ********add user  ****************************
info = Label(root, text='New Customer', fg='#363740',
             font=("Poppins", 15, "bold"))
info.place(x=200, y=200)
a = Label(root, text='____________________________________________________________________________________________________________________________________________________________________________________________')
a.place(x=190, y=230)
user_name = Label(root, text='Name', fg='#363740',
...
next_button = Button(root, text='NEXT', border=1, width=15, height=2,
                     bg='#3ECF0A', fg='#FAFAFA', font=("Poppins", 10), command=next)
next_button.place(x=880, y=550)

save_button = Button(root, text='Save Customer', border=1, width=20,
                     height=2, bg='#FFD580', fg='black', font=("Poppins", 10), command=save)

...
def search():
    try:
        con = mysql.connect(host='localhost', user='root',
                            password="", port="3306", database='pms')
        mycursor = con.cursor()
    except:
...
def medsearch():
    ...
    if q < 0:
        messagebox.showerror(
            "error", "you don't have this medicine in your stock")
    else:
...
dash = Button(text='Dashboard', width=19, height=2, border=0, bg='#595B67',
              fg='white', font=("Inter", 10, "bold"), cursor='hand2', command=dashboard)
dash.place(x=1, y=30)
medicine = Button(text='Medicine', border=0, bg='#363740', fg='white', font=(
    "Inter", 10, "bold"), cursor='hand2', command=medicine)
medicine.place(x=10, y=90)
category = Button(text='Category', border=0, bg='#363740', fg='white', font=(
    "Inter", 10, "bold"), cursor='hand2', command=category)
category.place(x=10, y=130)
billing = Button(text='Billing', width=19, height=2, border=0, bg='#595B67',
                 fg='white', font=("Inter", 10, "bold"), cursor='hand2', command=billing)
...
# ***************log out button*******************************
logout = Button(text='Log Out', border=0, bg='#363740', fg='white', font=(
...
old = Label(root, text='Search customer', fg='black',
            bg='#FAFAFA', font=("Poppins", 15, "bold"))
old.place(x=1020, y=80)
SEARCH = Label(root, text='contact:', bg='#FAFAFA',
               fg='black', font=("Poppins", 10))
SEARCH.place(x=950, y=130)
Button(root, text='search', bg='#FF702A', font=("Poppins", 10),
       width=5, command=search).place(x=1170, y=130, height=20)
searchentry = Entry(root, fg='#363740', font=("Poppins", 10), width=20)
searchentry.place(x=1010, y=130, height=20)

# search medicine field
MEDICINE = Label(root, text='Search Medicine', fg='black',
                 bg='#FAFAFA', font=("Poppins", 15, "bold"))
MEDICINE.place(x=1020, y=180)
medicineid = Label(root, text='Medicine ID', fg='black',
                   bg='#FAFAFA', font=("Poppins", 10))
medicineid.place(x=950, y=230)
qnty = Label(root, text='quantity', fg='black',
             bg='#FAFAFA', font=("Poppins", 10))
qnty.place(x=950, y=270)
qnty_entry = Entry(root, fg='#363740', font=("Poppins", 10), width=20)
qnty_entry.place(x=1030, y=270, height=20)
pre = Label(root, text='Prescription', fg='black',
            bg='#FAFAFA', font=("Poppins", 10))
...
Button(root, text='add', bg='#FF702A', font=("Poppins", 10),
       width=5, command=medsearch).place(x=1120, y=400, height=20)
...
billarea = Text(medicineListframe, yscrollcommand=scrolly.set,
                font=("Poppins", 10), fg='black')
...
total = Button(root, text='Total', bg='blue',
               font=("Poppins", 12), command=total)
total.place(x=400, y=480)

print_button = Button(root, text='Print', fg='black',
                      bg='green', font=("Poppins", 12), command=nikal)
